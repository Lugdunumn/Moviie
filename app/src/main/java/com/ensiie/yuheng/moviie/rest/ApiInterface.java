...
public interface ApiInterface {
    ...
    // @GET send get request, @Query add request parameter @Path , send request with a variable include within {}
    @GET("movie/top_rated")
    ...
    Call<MovieResponse> getPopularMovies(@Query("api_key") String apiKey, @Query("language") String language,
                                         ...
                                         @Query("include_video") String includeVideo, @Query("page") int pageNumber,
